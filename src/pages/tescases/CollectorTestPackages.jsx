...
export default function CollectorTestPackages() {
  ...
  const renderHead = () => (
    <tr>
      ...
      <th className="clu-th">
        <SortHeader label="Labs" path="labsCounter" sortBy={sortBy} sortDir={sortDir} onChange={onSortChange} />
      </th>
      <th className="clu-th">
        <SortHeader label="Test Case" path="testCaseCounter" sortBy={sortBy} sortDir={sortDir} onChange={onSortChange} />
      </th>
      <th className="clu-th">
        <SortHeader label="Price" path="price" sortBy={sortBy} sortDir={sortDir} onChange={onSortChange} />
      </th>
      <th className="clu-th">
        <SortHeader label="Discount Price" path="discountPrice" sortBy={sortBy} sortDir={sortDir} onChange={onSortChange} />
      </th>
      <th className="clu-th">
